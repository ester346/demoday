...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13-Maio-2021 às 16:50
...
(2, 1, 1, 'O que a palavra legend significa em português?', 'a)Legenda b) Conto c)  História d) lenda', ' alternativa a'),
(3, 3, 2, 'Quais os países que têm a maior e a menor expectativa de vida do mundo?', 'a)Itália e Chade b) Brasil e Congo c) Japão e Serra Leoa d)Estados Unidos e Angola', ' alternativa b'),
(4, 1, 1, 'O que significa YOU em ingles?', 'a)Você b) Ele c) Eu d) Ela ', ' alternativa a'),
(5, 3, 3, 'Quais as duas datas que são comemoradas em novembro?', 'a)Independência do Brasil e Dia da Bandeira b) Dia de Finados e Dia Nacional do Livro c)Proclamação da República e Dia Nacional da Consciência Negra d) Black Friday e Dia da Árvore ', ' alternativa c'),
...
INSERT INTO `usr_data` (`usr_id`, `usr_email`, `usr_nick`, `usr_pass`, `usr_ranking`) VALUES
(1, 'emaildaadriana@demoday.com.br', 'Adriana123', 'Sorvete03', 0),
(2, 'emaildomarcos@demoday.com.br', 'Marcos123', 'atirei o pau no ', 0),
(3, 'emaildovictor@demoday.com.br', 'vikit0us', 'k0natus', 0),
(4, 'emaildoezequiel@demoday.com', 'Ezequiel', '2345678', 0),
(5, 'emaildaester@demoday.com', 'Sté', '123456', 0),
(6, 'emaildolucas@demoday.com', 'lokaka', 'mjnh786', 0);
